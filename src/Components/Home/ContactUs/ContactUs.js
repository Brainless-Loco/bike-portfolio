        ...
        <div className="row w-100 text-center px-md-5 px-3 contactUs">
            <div className="col-md-6 mb-md-0 mb-3 float-left text-left" uk-scrollspy="cls: uk-animation-slide-left; delay:500; repeat: false">
                ...
                <div className="text-dark ml-3 px-2">
                    <h1 className="d-inline h1 text-color1 mr-3"> <i className="fas fa-envelope"></i> </h1> <a href="mailto::bikecsecu@gmail.com" className="h3 text-color1">bikecsecu@gmail.com</a>
                    <br/> <br />
                    <h1 className="d-inline h1 text-color1 mr-3"> <i className="fab fa-facebook"></i> </h1> <a href="mailto::bikecsecu@gmail.com" className="h3 text-color1">BIKE Lab Official Group</a>
                </div> 
            </div>
